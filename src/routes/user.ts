...
import { getUsers, postUser,getUser,uploadphoto,getPhotoUser,UpdatePasswordUser,updatePhoto,getUserByEmail,getUserByName,updateNameUser} from "../controllers/user";
...
router.put("/UserUpdateUsername/:nameuser/:newNameUser",updateNameUser);
export {router};